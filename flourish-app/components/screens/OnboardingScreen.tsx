...
const ONBOARDING_DATA = [
    {
        ...
        imagePath: require('@/assets/images/onboarding-1.png'),
    ...
    },
    {
        ...
        imagePath: require('@/assets/images/onboarding-2.png'),
        backgroundColor: Colors.background.cream,
        accentColor: Colors.primary.darkGreen,
    },
    {
        ...
        imagePath: require('@/assets/images/onboarding-3.png'),
        backgroundColor: Colors.background.cream,
        accentColor: Colors.primary.darkGreen,
    },
] as const;
...
const OnboardingScreen: React.FC = () => {
    ...
    const handleSkip = () => {
        // Navigate to Register Screen when ready
        // navigation.navigate('RegisterScreen');
        console.log('Skip to Register Screen');
    };
